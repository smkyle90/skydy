...
class Configuration(CoordinateSymbols):
    def __init__(self, name):
        ...
        As such, it is decribed by a vector of positions, and a matrix of rotations. All bodies can have up to 6 DOFs
        , i.e., directions in which it can move. By applying constraints, a body can have as little as zero DOFs.

        A Configuration inherits from CoordinateSymbols, as it is solely related to a body's name, and the 6 CoordinateSymbols that
        describe it.
    ...
    def apply_constraint(self, idx, const_value=0):
        ...
        Example:
            Constrain some coordinate for a body named "1".
                ...
                >>> body_name = "1"
                >>> body_config = Configuration(body_name)
                >>> # Apply a translational constraint to the z-axis, at a constant height of 5 m.
